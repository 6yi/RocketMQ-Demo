package cn.lzheng.orderserver.service;

import cn.lzheng.api.CouponService;
...
import cn.lzheng.orderserver.dao.TradeOrderMapper;
import cn.lzheng.pojo.*;
...
@DubboService
@Service
public class OrderServiceImpl implements cn.lzheng.api.OrderService {
    ...
    private void updateCouponStatus(TradeOrder order) {
        if(order.getCouponId()!=null){
            ...
            logger.info("订单:"+order.getOrderId()+",使用优惠券");
        }
    }
